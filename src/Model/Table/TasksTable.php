...
class TasksTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ->integer('task_id')
            ->allowEmptyString('task_id', 'create');

        $validator
            ->scalar('description_1')
            ->maxLength('description_1', 150)
            ->allowEmptyString('description_1');
        ...
        $validator
            ->integer('task_order')
            ->requirePresence('task_order', 'create')
            ->allowEmptyString('task_order', false);
